<script setup>
    ...
    const props = defineProps(['navLogo']);
    // console.log('nav-logo: ', props.navLogo);
    // console.log('nav-logo type: ', typeof props.navLogo);
...
<template>
    <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" :class="classes" viewBox="0 0 205.41 63.624">
